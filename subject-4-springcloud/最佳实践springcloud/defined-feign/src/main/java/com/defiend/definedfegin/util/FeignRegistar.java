package com.defiend.definedfegin.util;
...
public class FeignRegistar implements ImportBeanDefinitionRegistrar, EnvironmentAware, BeanClassLoaderAware ,
    ...
    private Object createProxy(AnnotatedBeanDefinition annotatedBeanDefinition) throws ClassNotFoundException {
        ...
        InvocationHandler invocationHandler = new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                if(method.getAnnotation(FeginGet.class)!=null) {
                   FeginGet feginGet = method.getAnnotation(FeginGet.class);
